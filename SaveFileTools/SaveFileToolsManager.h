...
/**
 *  This manager is an easy tool to manage your all kinds of custom SaveFileTools objects.
    
    SaveFileTools is a save file class that you can use it to save file and you can inherit it and create your own SaveFileTools object and your custom model in SaveFileTools class.
    ...
    SaveFileTools 是一個能儲存檔案的工具類別，你可以繼承他、並且建立自己的 Model （另一個類別 Model ），並且存在此類別的 Model property 中。
